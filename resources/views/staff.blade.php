                        ...
                        <div class="col-sm-7">
                            <a href="#"
                                class="btn btn-createProjects btn-danger w-md waves-effect waves-light mb-2 px-4 "><i
                                    class="mdi mdi-plus rounded-15"></i> Add Technician</a>
                        </div><!-- end col-->
                    </div>
                            ...
                            <div id="wrapper">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body">
                                                <h4 class="mt-0 header-title">Staff Table</h4>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <table id="datatable"
                                                                ...
                                                                <tbody class="text-center">
                                                                    <tr class="odd">
                                                                        <td class="dtr-control sorting_1" tabindex="0">1
                                                                        </td>
                                                                        <td>Accountant</td>
                                                                        <td>Tokyo</td>
                                                                        <td>33</td>
                                                                    ...
                                                                    <tr class="odd">
                                                                        <td class="dtr-control sorting_1" tabindex="0">3
                                                                        </td>
