                            ...
                            <div class="dropdown-menu dropdown-lg" id="search-dropdown">
                                ...
                                <div class="notification-list">
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        <div class="d-flex align-items-start">
                                            <img class="d-flex me-2 rounded-circle"
                                                src="{{ asset('templateAdmin/Admin/dist/assets/images/users/user-2.jpg') }}"
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        <div class="d-flex align-items-start">
                                            <img class="d-flex me-2 rounded-circle"
                                                src="{{ asset('templateAdmin/Admin/dist/assets/images/users/user-5.jpg') }}"
                                                alt="Generic placeholder image" height="32">
                                            <div class="w-100">
                        ...
                        <div class="noti-scroll" data-simplebar>
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item active">
                                <div class="notify-icon">
                                    <img src="{{ asset('templateAdmin/Admin/dist/assets/images/users/user-1.jpg') }}"
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <div class="notify-icon">
                                    <img src="{{ asset('templateAdmin/Admin/dist/assets/images/users/user-4.jpg') }}"
                                        class="img-fluid rounded-circle" alt="" />
                                </div>
        ...
        <div class="left-side-menu">
            ...
            <div class="h-100" data-simplebar>
                ...
                <div class="user-box text-center">
                    ...
                    <img src="{{ asset('templateAdmin/Admin/dist/assets/images/users/user-1.jpg') }}" alt="user-img"
